...
// necesitas un id unico para el canal, lo puedes obtener con la sgte fn:
function uuidv4() {
...
function suscribirse() {
    ...
    client.connect({}, function () {
        client.subscribe(canal, mostrarMensaje);
    });
}
